...
EU_FLAG = '''<svg width="66" height="44" viewBox="0 0 66 44" role="img" aria-label="Flag of the European Union"><rect width="66" height="44" fill="#003399"/><g fill="#FFCC00"><g id="s"><path d="M33 8 l1.176 3.62 3.804 0 -3.078 2.236 1.176 3.62 -3.078-2.237 -3.078 2.237 1.176-3.62 -3.078-2.236 3.804 0z" transform="scale(.62) translate(20.4 4)"/></g></g><g fill="#FFCC00" transform="translate(33 22)"><g id="stars">''' + ''.join(
    f'<path transform="rotate({a}) translate(0 -11) scale(.42)" d="M0-5 L1.47-1.55 5.2-1.55 2.18 .8 3.3 4.4 0 2.2 -3.3 4.4 -2.18 .8 -5.2-1.55 -1.47-1.55Z"/>' for a in range(0, 360, 30)
) + '</g></g></svg>'
