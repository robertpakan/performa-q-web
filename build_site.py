...
<section>
  <div class="wrap grid-2">
    <div class="rv">
      <video autoplay muted loop playsinline preload="metadata" poster="img/performa-2-poster.jpg" aria-label="Animated collage: a drag performer and two companions with green mustaches over colour shards" style="display:block;width:100%;border:3px solid #17150F">
